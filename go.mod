module github.com/ccbljty/langchaingo
...
//   - import "github.com/ccbljty/langchaingo/llms/openai" → only OpenAI-related deps
//   - import "github.com/ccbljty/langchaingo/vectorstores/chroma" → only Chroma deps
