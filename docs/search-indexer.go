...
func parseFlags() Config {
	...
	flag.StringVar(&config.PkgGoDevURL, "pkg-url", "https://pkg.go.dev/github.com/ccbljty/langchaingo", "pkg.go.dev base URL")
	flag.StringVar(&config.ModulePath, "module", "github.com/ccbljty/langchaingo", "Go module path")
