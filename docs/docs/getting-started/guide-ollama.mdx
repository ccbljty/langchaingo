...
2. **Run the example**: Enter the command:
   ```shell
   go run github.com/ccbljty/langchaingo/examples/ollama-completion-example@main
   ```
...
Here is the entire program (from [ollama-completion-example](https://github.com/ccbljty/langchaingo/blob/main/examples/ollama-completion-example/ollama_completion_example.go)):
