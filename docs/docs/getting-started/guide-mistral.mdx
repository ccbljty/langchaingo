...
```shell
go run github.com/ccbljty/langchaingo/examples/mistral-completion-example@main
```
...
Here is the entire program (from [mistral-completion-example](https://github.com/ccbljty/langchaingo/blob/main/examples/mistral-completion-example/mistral_completion_example.go)):
