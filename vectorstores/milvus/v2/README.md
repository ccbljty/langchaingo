...
1. **Update imports**:
   ```go
   // Old
   import "github.com/ccbljty/langchaingo/vectorstores/milvus"

   // New
   import "github.com/ccbljty/langchaingo/vectorstores/milvus/v2"
   ```
...
import (
    ...
    "github.com/ccbljty/langchaingo/vectorstores/milvus/v2"
)
...
- [LangChain Go Documentation](https://github.com/ccbljty/langchaingo)